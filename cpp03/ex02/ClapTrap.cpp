...
ClapTrap::ClapTrap() : m_name("ClapTrap"), m_hitpoints(100), m_attackDamage(20), m_energyPoints(50) {
	std::cout << "Default Clap constructor called" << std::endl;
};

ClapTrap::ClapTrap(std::string const &name) : m_name(name), m_hitpoints(100), m_attackDamage(20), m_energyPoints(50) {
	std::cout << "Clap Name constructor called with name: " << m_name << std::endl;
};
...
ClapTrap &ClapTrap::operator=(ClapTrap const &other) {
	...
	std::cout << "Clap Assignement operator called" << std::endl;
	return (*this);
}
...
void ClapTrap::attack(const std::string &target) {
	if (m_energyPoints > 0)
		std::cout << "ClapTrap " << m_name <<  " attacks " << target << " dealing " << m_attackDamage << " points of damage!" << std::endl;
	else {
